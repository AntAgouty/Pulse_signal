...
def apply_kalman_filter_to_chunk(df_chunk, y_col, new_col_name="kalman_filtered", n_iter=5, problematic_files=None):
    """
    ...
    problematic_files (list): List to capture files where issues occur.
